          ...
          <Container>
            ...
            <div className="flex mt-8 md:mt-16">
              <div className="flex-1 space-y-8 md:space-y-16">
                <h1 className="text-6xl sm:text-7xl md:text-6xl font-bold uppercase transform md:scale-150 md:translate-x-1/4" style={{ color: "#255b98" }}>Here's my <br /> personal space</h1>
