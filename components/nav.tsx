    ...
    <>
      <div className="sticky top-0 z-50 bg-white shadow-xl">
        ...
        <div className="fixed right-0 top-0 z-0 w-full">
          ...
          >
            <button
              className={`nav-toggle-btn block h-full w-full m-0 p-2 text-gray-50 border border-none rounded-full shadow-xl transition-transform transform focus:outline-none hover:opacity-95 ${
                isNavOpen ? "open" : ""
              }`}
          ...
          <div
            className={`flex justify-center fixed left-0 top-0 z-0 items-center w-full transition-transform transform  ${
              isNavOpen ? "translate-x-0" : "translate-x-full"
            }`}
          >
            <div
              onClick={closeNav}
              className={`overlay fixed top-0 left-0 z-0 w-screen h-screen bg-gray-600 opacity-0 ${
