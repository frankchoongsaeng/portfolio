        ...
        <Container>
          ...
          <div className="flex flex-grow items-stretch space-x-16 mt-14">
            <Card title="Social Me">
              <ListItem className="mr-4" link="https://linkedin.com">
          ...
          <form onSubmit={(e) => e.preventDefault()} className="mt-16">
            ...
            >
              <div className="flex-1 border-4 border-gray-500 overflow-hidden rounded">
                <textarea className="h-full w-full resize-none p-3 focus:opacity-100 focus:outline-none opacity-60" name="message" id="message" placeholder="Type your message here..."></textarea>
              </div>
              <div className="flex flex-col items-stretch space-y-4 flex-1">
                <div className="ct-form-control">
                  <input className="w-full p-3 border-4 border-gray-500 rounded-md focus:opacity-100 focus:outline-none opacity-60" type="text" placeholder="Full Name" />
                </div>
                <div className="ct-form-control">
                  <input className="w-full p-3 border-4 border-gray-500 rounded-md focus:opacity-100 focus:outline-none opacity-60" type="text" placeholder="Email" />
                </div>
                <div className="ct-form-control">
                  <input className="w-full p-3 border-4 border-gray-500 rounded-md focus:opacity-100 focus:outline-none opacity-60" type="text" placeholder="Subject" />
                </div>
