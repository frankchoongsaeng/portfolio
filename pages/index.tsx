...
export default function Home() {
  ...
  const timeoutRef: MutableRefObject<NodeJS.Timeout> = useRef(null);

  const setTempState = (newState: string) => {
    setSendingState(newState);
    timeoutRef.current = setTimeout(() => setSendingState("idle"), 3000);
  };
  ...
  const submitForm = ({ subject, email, fullname, message }) => {
    ...
    axios
      .post("/api/hello", { subject, email, fullname, message })
      .then(() => {
  ...
  const isDone = sendingState === "completed";
  const isFailed = sendingState === "failed";

  const sendMessageBtnContent: string = isSending
    ? "Patience..."
    : isDone
    ? "Sent"
    : isFailed
    ...
    <>
      <div className="hidden flex-col relative overflow-hidden">
        ...
        <div className="text-center w-80 mx-auto py-12">
          ...
          <p className="text-xs w-52 m-auto">
            This site is not currently available for small devices yet. <br />{" "}
            Please use a bigger device <i>(preferrably a 15 in. computer)</i>
          </p>
        </div>
      </div>
      ...
      <div className="">
        <MainLayout>
          {/* about me section */}
          <section
            className="min-h-screen relative pt-56 pb-32 overflow-hidden"
            id="about"
          >
            ...
            <Container>
              ...
              <p
                className="my-14 text-center mx-auto text-sm sm:text-base"
                style={{ maxWidth: "640px" }}
              >
                Single threaded, high performance.
                <br />
                Very focused and motivated, with high attention to details. Not
                being able to efficiently multitask is my weakness and it only
                goes to prove that I'm only human afterall. I like to work on
                cool projects that brings out every ounce of best in me.
                <br />
              ...
              <div className="flex flex-col sm:flex-row items-stretch justify-center space-y-8 sm:space-y-0 space-x-0 sm:space-x-8 md:space-x-12 lg:space-x-16 mt-14">
                <Card title="Social Me">
                  ...
                  <ListItem
                    className="lg:mr-4"
                    link="mailto:frankchoongsaeng@gmail.com"
                  >
                    <img
                  ...
                  <ListItem
                    className="lg:mr-4"
                    link="https://twitter.com/choongsaengF"
                  >
                    <img
                  ...
                  <ListItem
                    className="lg:mr-4"
                    link="https://www.facebook.com/frank.ebuka.94/"
                  >
                    <img
                  ...
                  <ListItem
                    className="lg:mr-4"
                    link="https://www.instagram.com/frank_choongsaeng/"
                  >
                    <img
                ...
                <Card title="Repos & Playgrounds">
                  <ListItem
                    className="lg:mr-4"
                    link="https://github.com/frankchoongsaeng"
                  >
                    <img
                  ...
                  <ListItem
                    className="lg:mr-4"
                    link="https://codepen.io/frankchoongsaeng/"
                  >
                    <img
                  ...
                  <ListItem
                    className="lg:mr-4"
                    link="https://codesandbox.io/u/frankchoongsaeng"
                  >
                    <img
          ...
          <section className="min-h-screen relative pt-56 pb-32 bg-gray-200 text-gray-800 overflow-hidden">
            ...
            <Container>
              ...
              >
                ...
                be <br /> a violent psychopath who knows where you live.
              </Quote>
              ...
              >
                Great question!.
                <br />
                Honestly, I don't think I have a good answer to 'Why Me'. No, I
                don't. <br />I can however, tell you that I have some many years
                of experience doing what I do, and that I am very good at what I
                do.
              </p>
          ...
          {/* contact section */}
          <section
            className="relative py-32 bg-gray-400 text-gray-800"
            id="contact"
          >
            <Container>
              ...
              <p className="pt-16 text-sm  text-center tracking-wide">
                <span className="opacity-90 font-bold">
                  Does whatsapp or calling sound better?
                </span>
                <br />
                <span className="inline-block font-medium mt-2 ">
                  <span className="inline-block mb-2 sm:inline sm:mb-0">
                    Here you go:
                  </span>{" "}
                  ...
                  <span className="inline-block font-bold tracking-wider mx-2">
                    ...
                    <a
                      ...
                      className="inline-block line-through text-gray-600 cursor-not-allowed"
                      title="Lost Nigerian Number"
                    >
                      +2348101511645
                    </a>
                  </span>
